...
class RockPaperScissorsEnvironment:
    ...
    def __init__(self):
        ...
        self.starting_points_combined = [np.array([[0.8,0.1,0.5],[0.6,0.1,0.9],[0.1,0.8,0.4]]),np.array([[0.2,0.8,0.4],[0.3,0.1,0.5],[0.2,0.6,0.2]]),np.array([[0.4,0.9,0.4],[0.2,0.5,0.7],[0.5,0.2,0.3]])]
